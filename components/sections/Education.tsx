...
export function Education() {
  ...
  return (
    <section id="education" className="relative px-6 py-28">
      <div aria-hidden className="aurora -right-20 top-4 h-64 w-64 bg-amber/16" />
      <div aria-hidden className="aurora -left-16 bottom-8 h-56 w-56 bg-amber/10" />
      ...
      <div className="relative mx-auto max-w-3xl">
        ...
        <div className="relative">
          <div className="absolute bottom-6 left-[31px] top-6 w-px bg-gradient-to-b from-amber/60 via-amber/25 to-transparent sm:left-[39px]" />
          ...
          <div className="flex flex-col gap-5">
            {EDUCATION.map((e, i) => (
              ...
              >
                <GlowCard className="group/glow rounded-2xl border border-line bg-surface p-5 transition-colors duration-300 hover:border-amber/35 sm:p-6">
                  <div className="grid grid-cols-[auto_minmax(0,1fr)] items-center gap-4 sm:grid-cols-[auto_minmax(0,1fr)_auto] sm:gap-5">
                    ...
                    <div className="min-w-0 flex-1">
                      <span className="font-mono text-[11px] uppercase tracking-[0.2em] text-amber-strong">
                        {e.period}
                      </span>
                    ...
                    {e.grade && (
                      ...
                      >
                        <span className="flex items-center gap-2 text-xs font-semibold text-dim sm:flex-col sm:gap-1">
                          <GraduationCap size={16} style={{ color: AMBER }} />
                          Grade
                        </span>
